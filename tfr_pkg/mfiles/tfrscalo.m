function [tfr,t,f,wt,im1]=tfrscalo(X,time,wave,fmin,fmax,N,trace);
...
if (nargout==0),
 ...
 %tfrqview(tfr,hilbert(real(X)),t,'TYPE1',wave,N,f);
else
 [im1] = tfrqview(tfr,hilbert(real(X)),t,'tfrscalo',wave,N,f);   
end;
