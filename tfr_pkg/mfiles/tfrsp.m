function [tfr,t,f,im1] = tfrsp(x,t,N,h,trace);
...
if (nargout==4),
 ...
 tfr = fftshift(tfr,1); %(Pav-add)positive and negative frequency alignment
 [im1] = tfrqview(tfr,x,t,'TYPE1',h); % Pavel Comment out prompt 
elseif (nargout==3),
 if rem(N,2)==0, 
  f=[0:N/2-1 -N/2:-1]'/N;
 else
